...
Registration(email,password,confirmPassword,nationality,dateOfBirth,accountType);
}
function Registration(email, pasword,confirmPassword,nationality,dateOfBirth,accountType)
{
